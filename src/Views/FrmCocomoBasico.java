...
public class FrmCocomoBasico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtEntradaSalida, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 60, 60, 30));

        jLabel1.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Modelo de Desarrollo");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 10, 220, 31));
        ...
        cobModelDesarrollo.setBackground(new java.awt.Color(0, 255, 204));
        ...
        cobModelDesarrollo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ORGÁNICO" }));
        ...
        cobModelDesarrollo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cobModelDesarrolloActionPerformed(evt);
            }
        });
        getContentPane().add(cobModelDesarrollo, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 10, 180, 31));

        jLabel3.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Cantidad de instrucciones");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, -1, 30));

        jLabel4.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Estimación del esfuerzo");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 170, -1, 30));

        jLabel5.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Estimacion del tiempo de desarrollo");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, -1, 30));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 350, -1, 30));

        jLabel8.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Estimación de productividad");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 300, -1, 30));

        jLabel9.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("METODO COCOMO I");
        ...
        getContentPane().add(txtTiempoDesarrollo, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 210, 108, -1));
        ...
        getContentPane().add(txtKlcd, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 130, 70, -1));

        jLabel10.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("LDC");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 130, 40, 30));

        jLabel11.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("KLDC");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 130, 50, 30));
        ...
        getContentPane().add(txtLdc, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 130, 108, -1));
        ...
        getContentPane().add(txtEstimacionEsfuerzo, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 170, 108, -1));
        ...
        getContentPane().add(txtPersonalNecesario, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, 108, -1));
        ...
        getContentPane().add(txtEstimacionProductividad, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 310, 108, -1));
        ...
        getContentPane().add(txtEstimacionCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 360, 108, -1));
        ...
        getContentPane().add(btnCalcular, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 430, 160, 36));

        jLabel12.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("persona/mes");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 170, 143, 30));

        jLabel13.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("persona/mes");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 260, 143, 30));

        jLabel14.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("meses");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 210, 143, 30));

        jLabel15.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("<html>instrucciones / persona mes</html>");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 290, 150, 60));

        jLabel17.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("costo estimado");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 360, 160, 30));
        ...
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 770, 480));
    ...
    private void cobModelDesarrolloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cobModelDesarrolloActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cobModelDesarrolloActionPerformed
